...
- Debes separar su experiencia profesional en la empresa Fermax (donde es Software Engineer enfocado en IoT, arquitecturas DDD) de sus intereses o formación personal actual en IA. En Fermax NO trabaja con RAG, LangChain/LangGraph, ni Agentes Autónomos.
"""
