...
## Idea central {#primero-el-domain-event-despues-el-broker}
...
## Convención de nombrado {#la-convencion-de-nombrado}
...
## Matiz técnico importante {#el-ejemplo-usa-rabbitmq}
...
## RabbitMQ y Kafka {#rabbitmq-y-kafka-no-son-la-misma-cosa}
...
## Buenas prácticas {#checklist-pragmatico}
