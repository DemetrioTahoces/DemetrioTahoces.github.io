...
| `pytest -m evals` | 35 casos (44 ejecuciones): hechos, honestidad, inyección, idioma, historial, blog, citas. Métricas de citas: validez (URL exacta, antes de la validación) ≥ 90 % y cobertura de párrafos ≥ 80 %. Juez: `gpt-6-luna` | Céntimos |
